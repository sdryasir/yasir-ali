            ...
            <div className="row banner__content">
                    ...
                    <div className="my-0 my-md-5 ">
                        ...
                        <div className="banner__btn-wrap mt-0 d-flex align-items-center">
                            <div className="tg-button-wrap">
                                <button onClick={scrollToCourses} id="explore" className="btn btn-primary btn-action tg-svg d-flex gap-2 align-items-center p-2 px-4 rounded-0">
                ...
                <div className="col-lg-6">
                    <div className="banner__images d-none d-md-flex" style={{'display':'flex','justifyContent':'end'}}>
                        ...
                        <Image decoding="async" src="/img/bshape_03.png" alt="shape" className="shape" width={50} height={50}/>
                        <Image decoding="async" src="/img/bshape_04.png" alt="shape" className="shape" width={50} height={50}/>
                        <Image decoding="async" src="/img/bshape_05.png" alt="shape" className="shape" width={50} height={50}/>
                    </div>
                </div>
            </div>
        </div>
